...
const Project = () => {
  ...
  const getdata = () => {
    axios.get("https://toggoletrackbackend.onrender.com/project",{
     headers:{
  ...
  axios
    .post("https://toggoletrackbackend.onrender.com/project/create", payload,{
      headers:{
        "authorization":`Bearer ${token}`
      },
    })
  ...
  const deletedata=(id)=>{
    axios
    .delete(`https://toggoletrackbackend.onrender.com/project/delete/${id}`,{
      headers:{
        "authorization":`Bearer ${token}`
      }})
    .then((res) => {
  ...
  const handleEdit=(id)=>{
    axios
    .patch(`https://toggoletrackbackend.onrender.com/project/edit/${id}`,{},{
      headers:{
        "authorization":`Bearer ${token}`
      }})
