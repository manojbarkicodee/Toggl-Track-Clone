...
axios.post("https://toggoletrackbackend.onrender.com/client/create", payload,{
    headers:{
      "authorization":`Bearer ${token}`
    },
  ...
  const deletedata=(id)=>{
    ...
    axios.delete(`https://toggoletrackbackend.onrender.com/client/delete/${id}`,{
      headers:{
        "authorization":`Bearer ${token}`
      }})
    .then((res) => {
  ...
  const handleEdit=()=>{
    ...
    const payload = {
      ...
      axios.patch(`https://toggoletrackbackend.onrender.com/client/edit/${id}`,payload,{
        headers:{
          "authorization":`Bearer ${token}`
        }})
      .then((res) => {
  ...
  const handleSearch=()=>{
      axios.get(`https://toggoletrackbackend.onrender.com/client/search?client=${searchclient}`,{
        headers:{
          "authorization":`Bearer ${token}`
        }})
