...
const getdata = () => {
  axios.get(`https://toggoletrackbackend.onrender.com/tags`,{
   headers:{
...
axios
  .post(`https://toggoletrackbackend.onrender.com/tags/create`,payload,{
    headers:{
      "authorization":`Bearer ${token}`
    },
  ...
  const handleSearch=()=>{
    axios.get(`https://toggoletrackbackend.onrender.com/tags/search?tag=${search}`,{headers:{
      "authorization":`Bearer ${token}`
  ...
  const deletedata=(id)=>{
    console.log(id)
    axios
    .delete(`https://toggoletrackbackend.onrender.com/tags/delete/${id}`,{
      headers:{
        "authorization":`Bearer ${token}`
      },
    })
